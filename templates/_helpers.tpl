...
{{/* Create the name of blackbox service account to use */}}
{{- define "kube-prometheus-stack.blackbox.serviceAccountName" -}}
{{- if .Values.blackbox.serviceAccount.create -}}
    {{ default (print (include "kube-prometheus-stack.fullname" .) "-blackbox") .Values.blackbox.serviceAccount.name }}
{{- else -}}
    {{ default "default" .Values.blackbox.serviceAccount.name }}
{{- end -}}
{{- end -}}
